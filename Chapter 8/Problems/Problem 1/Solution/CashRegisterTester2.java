public class CashRegisterTester2
{
   public static void main(String[] args)
   {
      ...
      myRegister.receivePayment(1, new Coin(QUARTER_VALUE, "quarter"));
      myRegister.receivePayment(1, new Coin(NICKEL_VALUE, "nickel"));
      myRegister.receivePayment(2, new Coin(PENNY_VALUE, "penny"));

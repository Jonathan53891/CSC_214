...
where the user enters a comma in the input. Then print the 
...
Suppose it contains n characters. Then extract substrings consisting of the 
first n – 4 characters and the last three characters.
